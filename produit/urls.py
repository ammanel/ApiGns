...
urlpatterns = [
    ...
    path('liste/switch', views.SwitchListAPIView.as_view(), name='liste_switch'),
    path('update/switch/<int:switch_id>', views.SwitchUpdateAPIView.as_view(), name='update_switch'),
    path('delete/switch/<int:switch_id>', views.SwitchDeleteAPIView.as_view(), name='delete_switch'),

    #crud catégorie équipement
    path('enregistrer/categorie/Equipement', views.CategorieECreateAPIView.as_view(), name='creer_cat_equipement'),
    path('liste/categorie/Equipement', views.CategorieEListAPIView.as_view(), name='liste_cat_equipement'),
